...
history = model.fit(X_train_reshaped, y_train, epochs=120, batch_size=16, validation_split=0.8)
...
# Save the model
model.save('trained_model_T9.h5')
print("Model saved as 'trained_model_T9.h5'")
