...
checkpoint = ModelCheckpoint('DNN_V2_Best_Validations__T8_T7_T9_rmsprop_T112.keras', save_best_only=True, monitor='val_loss', mode='min')
...
# Save the model
model.save('trained_model_T8_T7_T9_rmsprop_T112.keras')
print("Model saved as 'trained_model_T8_T7_T9_rmsprop_T112.keras'")
