...
checkpoint = ModelCheckpoint('DNN_V2_Best_Validations__T11_T10_rmsprop_T112.keras', save_best_only=True, monitor='val_loss', mode='min')
...
# Save the model
model.save('trained_model_T11_T10_rmsprop_T112.keras')
print("Model saved as 'trained_model_T11_T10_rmsprop_T112.keras'")
