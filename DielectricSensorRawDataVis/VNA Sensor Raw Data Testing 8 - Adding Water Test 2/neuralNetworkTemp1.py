...
history = model.fit(X_train_reshaped, y_train, epochs=40, batch_size=16, validation_split=0.2)
...
# Save the model
model.save('trained_model_T8.h5')
print("Model saved as 'trained_model_T8.h5'")
